...
const facebookCountries = [
    ...
    { name: 'Yemen', code: '+967', price: 29, countryId: 30, flag: '🇾🇪' },
    { name: 'Indonesia', code: '+62', price: 33, countryId: 6, flag: '🇮🇩' },
    { name: 'Kenya', code: '+254', price: 30, countryId: 8, flag: '🇰🇪' },
    { name: 'Nigeria', code: '+234', price: 34, countryId: 19, flag: '🇳🇬' },
    { name: 'Colombia', code: '+57', price: 32, countryId: 33, flag: '🇨🇴' },
    { name: 'Brazil', code: '+55', price: 29, countryId: 73, flag: '🇧🇷' },
    { name: 'South Africa', code: '+27', price: 31, countryId: 31, flag: '🇿🇦' },
    { name: 'Tanzania', code: '+255', price: 33, countryId: 9, flag: '🇹🇿' },
    { name: 'India', code: '+91', price: 30, countryId: 22, flag: '🇮🇳' },
    { name: 'Spain', code: '+34', price: 34, countryId: 56, flag: '🇪🇸' },
    { name: 'Philippines', code: '+63', price: 29, countryId: 4, flag: '🇵🇭' },
    { name: 'Cambodia', code: '+855', price: 32, countryId: 24, flag: '🇰🇭' },
    { name: 'Chile', code: '+56', price: 31, countryId: 151, flag: '🇨🇱' },
    { name: 'Saudi Arabia', code: '+966', price: 33, countryId: 53, flag: '🇸🇦' },
    { name: 'Ghana', code: '+233', price: 30, countryId: 38, flag: '🇬🇭' },
    { name: 'Argentina', code: '+54', price: 34, countryId: 39, flag: '🇦🇷' },
    { name: 'Sri Lanka', code: '+94', price: 29, countryId: 64, flag: '🇱🇰' },
    { name: 'Sweden', code: '+46', price: 32, countryId: 46, flag: '🇸🇪' },
    { name: 'Ukraine', code: '+380', price: 31, countryId: 1, flag: '🇺🇦' },
    { name: 'Vietnam', code: '+84', price: 33, countryId: 10, flag: '🇻🇳' },
    { name: 'Germany', code: '+49', price: 30, countryId: 43, flag: '🇩🇪' },
    { name: 'Bulgaria', code: '+359', price: 34, countryId: 83, flag: '🇧🇬' },
    { name: 'Poland', code: '+48', price: 29, countryId: 15, flag: '🇵🇱' },
    { name: 'Thailand', code: '+66', price: 32, countryId: 52, flag: '🇹🇭' },
    { name: 'Mozambique', code: '+258', price: 31, countryId: 80, flag: '🇲🇿' },
    { name: 'Mexico', code: '+52', price: 33, countryId: 54, flag: '🇲🇽' },
    { name: 'Jamaica', code: '+1', price: 100, countryId: 103, flag: '🇯🇲' },
    { name: 'Ecuador', code: '+593', price: 30, countryId: 105, flag: '🇪🇨' },
    { name: 'Syria', code: '+963', price: 34, countryId: 1333, flag: '🇸🇾' },
    { name: 'Guatemala', code: '+502', price: 80, countryId: 94, flag: '🇬🇹' },
    { name: 'France', code: '+33', price: 29, countryId: 78, flag: '🇫🇷' },
    { name: 'Morocco', code: '+212', price: 32, countryId: 37, flag: '🇲🇦' },
    { name: 'Malaysia', code: '+60', price: 31, countryId: 7, flag: '🇲🇾' },
    { name: 'Portugal', code: '+351', price: 33, countryId: 117, flag: '🇵🇹' },
    { name: 'Turkey', code: '+90', price: 30, countryId: 62, flag: '🇹🇷' },
    { name: 'Uruguay', code: '+598', price: 34, countryId: 156, flag: '🇺🇾' },
    { name: 'Bangladesh', code: '+880', price: 70, countryId: 60, flag: '🇧🇩' },
    { name: 'Romania', code: '+40', price: 29, countryId: 32, flag: '🇷🇴' },
    { name: 'Italy', code: '+39', price: 32, countryId: 86, flag: '🇮🇹' },
    { name: 'Australia', code: '+61', price: 31, countryId: 175, flag: '🇦🇺' },
    { name: 'Paraguay', code: '+595', price: 33, countryId: 87, flag: '🇵🇾' },
    { name: 'Guyana', code: '+592', price: 30, countryId: 131, flag: '🇬🇾' },
    { name: 'Iraq', code: '+964', price: 34, countryId: 47, flag: '🇮🇶' },
    { name: 'Congo', code: '+242', price: 70, countryId: 150, flag: '🇨🇬' },
    { name: 'Cameroon', code: '+237', price: 29, countryId: 41, flag: '🇨🇲' },
    { name: 'Czech Republic', code: '+420', price: 32, countryId: 63, flag: '🇨🇿' },
    { name: 'Timor-Leste', code: '+670', price: 80, countryId: 91, flag: '🇹🇱' },
    { name: 'Venezuela', code: '+58', price: 31, countryId: 70, flag: '🇻🇪' },
    { name: 'Pakistan', code: '+92', price: 33, countryId: 66, flag: '🇵🇰' },
    { name: 'Zambia', code: '+260', price: 30, countryId: 147, flag: '🇿🇲' },
    { name: 'Senegal', code: '+221', price: 34, countryId: 61, flag: '🇸🇳' }
];
